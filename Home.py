...
def main():
    ...
    #     "description": "An advanced Optical Character Recognition (OCR) system that accurately digitizes text from images, enhancing accessibility and efficiency in document-heavy workflows.",
    #     "image": "https://www.4th-ir.com/favicon.ico"
    # },
    "Ride-router": {
